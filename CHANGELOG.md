...
### 🐛 Bug Fixes
- **Fixed Yahoo Finance price fetching** - Upgraded `yahoo-finance2` from v2.13.3 to v3.11.2 to fix rate limiting and API compatibility issues that prevented Bitcoin price update
